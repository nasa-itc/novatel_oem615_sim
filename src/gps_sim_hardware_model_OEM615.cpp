...
namespace Nos3
{
    ...
    void GPSSimHardwareModelOEM615::get_gpggaa_response(const GPSSimDataPoint& data_point, std::vector<uint8_t>& out_data)
    {
        ...
        sim_logger->trace("GPSSimHardwareModelOEM615::get_gpgga_string:  abs_time: %12.4f to Julian date/time: %4.4d/%2.2d/%2.2d %2.2d:%2.2d:%5.2f",
        ...
        double utc = hour * 10000 + minute * 100 + second; // hhmmss.ss
